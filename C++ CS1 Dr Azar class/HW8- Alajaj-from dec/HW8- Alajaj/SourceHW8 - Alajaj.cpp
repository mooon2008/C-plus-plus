...
void Data(char&, int&, char&, char[13][6]);

void printout(char[13][6], int, char);
void printfirstonly(char[13][6], int, char);
void printBusinessOnly(char[13][6], int, char);
void printEcononly(char[13][6], int, char);
...
void Data(char& tType, int& row, char& column, char Seats[13][6])// define function Data when user want to select a seat
...
void printout(char Seats[13][6], int row, char column)// define printout function to show info in file and screen 
...
void printfirstonly(char Seats[13][6], int row, char column)
{
	int i, j; // dcleare  variables
	char x = 'X';
...
void printBusinessOnly(char Seats[13][6], int row, char column)
{
	int i, j; // dcleare  variables
	char x = 'X';
...
void printEcononly(char Seats[13][6], int row, char column)
{
	int i, j; // dcleare  variables
	char x = 'X';
